...
const suggestions = [
  ...
  },
  {
    ...
    description:
      'Aumentar em 5% o preço dos anzóis especiais, que têm alta demanda e baixa sensibilidade a preço.',
    impact: 'Médio',
    status: 'implemented',
  },
  {
    ...
    description:
      'Criar uma promoção especial para molinetes durante a temporada de pesca que se aproxima.',
    impact: 'Alto',
    status: 'pending',
  },
];
  ...
  return (
    <Card className="col-span-2">
      <CardHeader>
        ...
        <CardDescription>
          Recomendações baseadas em análise de dados para melhorar seu negócio
        </CardDescription>
      </CardHeader>
