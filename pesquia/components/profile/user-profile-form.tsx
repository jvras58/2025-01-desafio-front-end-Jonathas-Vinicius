...
import { UserProfileFormValues, userProfileSchema } from "@/schemas/user-schema"
...
export function UserProfileForm() {
  ...
  const { data: userData, isLoading: isFetching, error } = useQuery<UserProfileData>({
          ...
          <CardContent className="space-y-6 pt-4">
            ...
            <Avatar className="h-24 w-24">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Sua foto será exibida em seu perfil</p>
              </div>
            </div>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input id="name" className="pl-10" placeholder="Seu nome completo" {...field} />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input id="email" className="pl-10" placeholder="seu.email@exemplo.com" {...field} />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
            ...
            <div className="space-y-4 pt-2">
              <h3 className="text-sm font-medium text-muted-foreground">Alterar Senha</h3>
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <FormField
                  control={form.control}
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input id="currentPassword" className="pl-10" type="password" placeholder="Digite sua senha atual" {...field} />
                        </div>
                      </FormControl>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          <Lock className="absolute left-3 top-2.5 h-4 w-4 text-muted-foreground" />
                          <Input id="newPassword" className="pl-10" type="password" placeholder="Digite sua nova senha" {...field} />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          <Lock className="absolute left-3 top-2.5 h-4 w-4 text-muted-foreground" />
                          <Input id="confirmPassword" className="pl-10" type="password" placeholder="Confirme sua nova senha" {...field} />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
