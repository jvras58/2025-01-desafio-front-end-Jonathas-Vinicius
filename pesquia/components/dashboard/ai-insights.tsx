  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Análises e recomendações baseadas em dados
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="flex items-start gap-3 rounded-lg border p-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              5 produtos populares estão com estoque abaixo do nível crítico.
              Recomendamos fazer pedidos de reposição imediatamente para evitar
              perda de vendas.
            </p>
          </div>
        </div>
