            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">
                  Gestão inteligente para o setor de{' '}
                  <span className="text-primary">pesca</span>
                </h1>
                <p className="max-w-[600px] text-muted-foreground md:text-xl">
                  O pesquIA é um sistema ERP completo que utiliza inteligência
                  artificial para otimizar a gestão de produtos de pescaria,
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center text-center">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                Pronto para <span className="text-primary">revolucionar</span>{' '}
                seu negócio?
              </h2>
              <p className="mt-4 max-w-[700px] text-muted-foreground md:text-xl">
                Entre em contato conosco hoje mesmo e descubra como o pesquIA
                pode transformar a gestão da sua empresa de pesca.
              </p>
            </div>
          </div>
        </section>
